...
const { title, skillLevel, description, tags, technologies } = defineProps([
    "title",
    "skill-level",
    "description",
    "tags",
...
<template>
    <li ref="itemRef" class="fade-in-up-inactive">
        <hr class="bg-muted-500 " />
        <div class="flex flex-col items-center timeline-end">
            <div class="w-full my-6 ml-8 shadow-xl card bg-base-100">
                <div class="card-body">
                    <div class="flex flex-row gap-x-2">
                        <div v-for="technology in technologies">
                            ...
                            <img :src="'/technologies/' +
                                technology.image +
                                '.png'
                                " :alt="technology.name" class="w-8 h-8" />
                            </Link>
                        </div>
                    </div>
                    <h2 class="card-title">
